...
In \texttt{Examples/CSiSTD} we do a simulation of a crystalline solar cell with three bus-bars. This example shows how one can efficiently create a rectilinear mesh for a typical crystalline silicon solar cell grid. Optionally we also demonstrate the inclusion of a complicated shading pattern. 
